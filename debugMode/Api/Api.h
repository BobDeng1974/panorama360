...
#define ACCURACY_BIT		10				//计算精度位数
#define ACCURACY_NUM		1024			//计算精度大小
#define ACCURACY_POINT		0x000003FF		//计算精度小数部分

#define WeightAccuracyBit   8				//权值计算精度位数
#define WeightAccuracNum	256				//权值精度大小
#define WeightAccuracyPoint 0x000000FF		//权值精度小数部分
